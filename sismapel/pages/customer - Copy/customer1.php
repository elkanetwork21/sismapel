...
// update payment_status default = 0
$conn->query("UPDATE customers SET payment_status = 0");

// update payment_status = 1 untuk customer dengan pembayaran bulan ini
$conn->query("
  UPDATE customers c
    JOIN (
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow-sm">
        <div class="card-header">
          ...
          <a href="tambah_customer.php"  class="btn btn-outline-primary">+ Tambah customer</a>
