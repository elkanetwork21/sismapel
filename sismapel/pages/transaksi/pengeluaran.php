        ...
        <div class="card shadow-lg border-0 rounded-4">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col">
                <h4 class="mb-0"><i class="bi bi-table me-2"></i> Pengeluaran</h4>
              </div>
              <div class="col text-end">
                <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalPengeluaran">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id="tabelPengeluaran" class="table table-striped w-100">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content rounded-4">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title"><i class="bi bi-wallet2 me-2"></i> Tambah Pengeluaran</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
      </div>
      <form action="simpan_pengeluaran.php" method="POST" enctype="multipart/form-data" id="pengeluaranForm">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select name="kategori_id" class="form-select" required>
              ...
              <?php 
              $kategori = $conn->query("SELECT id, nama_kategori FROM kategori_pengeluaran WHERE branch_id='$branch_id'");
          ...
          <div class="mb-3">
            ...
            <div class="form-text">Bisa upload bukti nota/struk (jpg, png, pdf)</div>
          </div>
      ...
      success: function(res){
        if(res.trim() === "success"){
          Swal.fire({
            ...
            window.location.href = "pengeluaran?token=<?php echo $_SESSION['csrf_token']?>";
          });
  ...
  columns: [
    ...
    { 
      ...
      render: function(data){
        if(!data) return '-';
        return `<a href="uploads/lampiran/${data}" target="_blank">Lihat</a>`;
      }
    },
    { 
      data: 'id',
